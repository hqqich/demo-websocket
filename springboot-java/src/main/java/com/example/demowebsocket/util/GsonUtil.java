...
/**
 * Created by admin on 2022/6/22 is 11:48.
 *
 * @Description
...
//                .setPrettyPrinting() //自动格式化换行
     ...
     * @return
     */
    public static <T> HashMap<String, T> strToMaps(String gsonString) {
        return GSON.fromJson(gsonString, new TypeToken<HashMap<String, T>>() {}.getType());
    }
